...
public class SimpleAddition extends JFrame {
    ...
    public JPanel createContentPane() {
         ...
         * the current value
         */
        class testFieldListener implements ActionListener {
            @Override
        ...
        addend1Field.addActionListener(new testFieldListener());
        addend2Field.addActionListener(new testFieldListener());
